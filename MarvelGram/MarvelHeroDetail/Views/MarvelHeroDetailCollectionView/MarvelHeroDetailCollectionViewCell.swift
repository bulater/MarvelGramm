//
//  MarvelHeroDetailCollectionViewCell.swift
//  MarvelGram
//
...
class MarvelHeroDetailCollectionViewCell: UICollectionViewCell {
    // MARK: - Public Propertires

    static let cellID = "MarvelHeroDetailCollectionViewCellID"
